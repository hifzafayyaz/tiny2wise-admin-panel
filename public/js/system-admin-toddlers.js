...
const toddlerSearch = document.getElementById("toddlerSearch");
const toddlersTableBody = document.getElementById("toddlersTableBody");
...
if (toddlerSearch && toddlersTableBody) {
  toddlerSearch.addEventListener("input", () => {
    const value = toddlerSearch.value.toLowerCase().trim();
    const rows = toddlersTableBody.querySelectorAll("tr");
